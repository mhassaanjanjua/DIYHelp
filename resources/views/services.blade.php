                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                            <div class="all_items-box-text">
                                <h2>{{ $user['title'] }}</h2>
                                <span class="prize">Euro {{ $user['wage'] }}</span>
                            </div>
                            <div class="all_items-box-text">
                ...
                <a href="order_details.html">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
                            ...
                            <div class="all_items-box-text">
                                <p>I need to repair my door. Can anyone offer his/her services</p>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col xs-12">
                ...
                <div class="acknowledge-box-button">
                    <a href="post/create_service" class="btn btn-primary"><span>Post an Ad</span><img src="/images/right-white.png"></a>
                </div>
            </div>
        </div>
